            ...
            <div class="nav flex-row nav-pills  col-4" id="v-pills-tab" role="tablist" aria-orientation="horizontal"
             style="height: 35rem; overflow-y: scroll; /* width:350px !important */">
               ...
               <div class="alert alert-warning alert-dismissible fade show mt-3" role="alert">
                Filtered by : <br>
                <strong>{{ $plaintes->first()->statut }}</strong>                 

                <a href="{{route('plaintes.index')}}">
                        ...
                        <div class="card-body">
                                ...
                                <div class="d-flex  justify-content-around">
                                    <div class="">
                                        <p>Email : <span class="badge badge-light p-2">
                                            {{App\Models\clients::where(['id'=> $plainte->client_id]) ->first()->email}}</span></p>
                                    </div>

                                    <div class="">
                                        <p>statut : <span class="badge 
                                            
                                            @if( App\Models\clients::where(['id'=> $plainte->client_id]) ->first()->statut_activite == 1)
                                                badge-success
                                                @else
                                                badge-danger
                                            @endif
                                    ...
                                    <div class="">
                                        <p>Contact : <span class="badge badge-light  p-2">
                                            {{App\Models\clients::where(['id'=> $plainte->client_id]) ->first()->contact}}</span></p>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        <p class=" mr-4 mt-5"">by : {{App\Models\clients::where(['id'=> $plainte->client_id]) ->first()->name}}</p>
                                    </div>
